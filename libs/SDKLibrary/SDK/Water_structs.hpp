...
public:
	...
	uint8                                        Pad_5B3[0x1AB];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5B4[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_5D3[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
