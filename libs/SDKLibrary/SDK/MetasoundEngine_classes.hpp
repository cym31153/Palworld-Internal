...
{
public:
	uint8                                        Pad_2B95[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2B9F[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2BA1[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2BA3[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
