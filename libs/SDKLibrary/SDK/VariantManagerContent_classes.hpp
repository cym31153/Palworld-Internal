...
public:
	...
	uint8                                        Pad_24C2[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_24DD[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_24E2[0x77];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_24E3[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
