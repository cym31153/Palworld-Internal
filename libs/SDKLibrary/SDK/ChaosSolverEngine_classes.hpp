...
{
public:
	uint8                                        Pad_34B5[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_34B6[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_34B8[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_34C5[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
