...
{
public:
	uint8                                        Pad_276F[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2770[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2771[0x9];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2772[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
