...
{
public:
	uint8                                        Pad_1D4E[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1D54[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
