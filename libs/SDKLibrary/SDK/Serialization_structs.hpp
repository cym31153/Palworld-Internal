...
public:
	...
	uint8                                        Pad_3A16[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3A1F[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3A22[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3A25[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
