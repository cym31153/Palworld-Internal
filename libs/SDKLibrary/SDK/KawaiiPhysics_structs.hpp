...
public:
	...
	uint8                                        Pad_1C89[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1C8A[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1C99[0x4F];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1C9A[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
