...
{
public:
	uint8                                        Pad_CCF[0x88];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CD0[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_CD2[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
